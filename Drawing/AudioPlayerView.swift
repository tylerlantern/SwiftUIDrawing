...
let backgroundColor = Color(red: 229 / 255, green: 229 / 255, blue: 229 / 255)
let backgroundSecondaryColor = Color(red: 204 / 255, green: 204 / 255, blue: 206 / 255)
let primaryColor = Color(red: 2 / 255, green: 104 / 255, blue: 167 / 255)
...
struct AudioPlayerView_Previews: PreviewProvider {
    static var previews: some View {
        AudioPlayerView(state: .constant(.playing), progressInSeconds: .constant(20), lenghtOfVideosInSeconds: .constant(60))
            .frame(height: 55)
    }
}
